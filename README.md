...
## Changelog
### <strong>Sep 09 2026 Update:</strong>
- Added new units, edited patched units, and fixed bugs
...
- Added Aki, Ritual of Sealing Flames, and 1/8 Balance patch changes.
...
- Updated spreadsheet link. Added some missing translations for Português (BR). 
